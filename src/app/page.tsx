  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <main className="flex flex-1 items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-white">User Forum</h1>
            <p className="mt-2 text-slate-400">
              Create forums, and interact through comments/questions
            </p>
          </div>
          <AuthForm />
        </div>
      ...
      <footer className="py-4 text-center text-sm text-slate-500">
        © {new Date().getFullYear()} User Forum. All rights reserved.
      </footer>
    </div>
  );
}
